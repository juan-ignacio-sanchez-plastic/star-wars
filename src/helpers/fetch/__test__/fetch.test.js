import { getData, getListOfCharacters, getCharacter, getFilm } from '../fetch';

jest.mock('../fetch');

it('getData should return the correct data', async () => {
  const res = await getData(`/people/1`);
...
it('getListOfCharacters should return a list of characters on res.results', async () => {
  const res = await getListOfCharacters(1);
...
it('getCharacter should return the character data', async () => {
...
it('getFilm should return the film data', async () => {
  const res = await getFilm(1);
